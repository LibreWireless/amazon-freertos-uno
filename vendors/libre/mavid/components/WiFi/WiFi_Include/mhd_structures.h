...
/** @file
 *  Defines common structures used with MHD
 *
 */

#ifndef INCLUDED_MHD_STRUCTURES_H
#define INCLUDED_MHD_STRUCTURES_H
...
typedef uint32_t          mhd_time_t;          /* Time value in milliseconds */
typedef wl_bss_info_t     host_bss_info_t;

typedef edcf_acparam_t    host_edcf_ac_param_t;
typedef wl_action_frame_t host_action_frame_t;
...
typedef struct
{
    ...
    host_packet_filter_rule_t     rule;          /**< Filter matches are either POSITIVE or NEGATIVE matching */
    ...
    host_bool_t                   enabled_status; /**< When returned from mhd_wifi_get_packet_filters, indicates if the filter is enabled */
} host_packet_filter_t;

/** @cond */
typedef wl_pkt_filter_stats_t host_packet_filter_stats_t;
/** @endcond */
 ...
 */
#pragma pack(1)
typedef struct host_ap_info
{
    host_ssid_t              SSID;             /**< Service Set Identification (i.e. Name of Access Point)                    */
    host_mac_t               BSSID;            /**< Basic Service Set Identification (i.e. MAC address of Access Point)       */
    ...
    host_bss_type_t          bss_type;         /**< Network type                                                              */
    host_security_t          security;         /**< Security type                                                             */
    uint8_t                   channel;          /**< Radio channel that the AP beacon was received on                          */
    host_802_11_band_t       band;             /**< Radio band                                                                */
    struct host_ap_info*     next;             /**< Pointer to the next scan result                                           */
} host_ap_info_t;
#pragma pack()
 ...
 */
#pragma pack(1)
typedef struct host_scan_result
{
    host_ssid_t              SSID;             /**< Service Set Identification (i.e. Name of Access Point)                    */
    host_mac_t               BSSID;            /**< Basic Service Set Identification (i.e. MAC address of Access Point)       */
    int16_t                   signal_strength;  /**< Receive Signal Strength Indication in dBm. <-90=Very poor, >-30=Excellent */
    ...
    uint8_t                   channel;          /**< Radio channel that the AP beacon was received on                          */
    host_802_11_band_t       band;             /**< Radio band                                                                */
    host_bool_t              on_channel;       /**< True if scan result was recorded on the channel advertised in the packet  */
    struct host_scan_result* next;             /**< Pointer to the next scan result                                           */
} host_scan_result_t;
#pragma pack()
 ...
 * See @ref host_wifi_get_listen_interval for more information
 */
typedef struct
{
...
typedef struct
{
    ...
    host_mac_t   mac_list[1];   /**< Variable length array of MAC addresses */
} host_maclist_t;
...
#endif /* ifndef INCLUDED_MHD_STRUCTURES_H */
