 ...
 *  Host and user applications to receive event callbacks.
 */

#ifndef INCLUDED_MHD_EVENTS_H
#define INCLUDED_MHD_EVENTS_H
...
typedef struct host_event_header_struct mhd_event_header_t;

/**
 * Event handler prototype definition
 */
typedef void* (*mhd_event_handler_t)( const mhd_event_header_t* event_header, const uint8_t* event_data, /*@null@*/ void* handler_user_data );
 ...
 *                        See @ref mhd_event_num_t for available events.
 ...
 */
extern mhd_result_t mhd_management_set_event_handler( /*@keep@*/ const mhd_event_num_t* event_nums, /*@null@*/ mhd_event_handler_t handler_func, /*@null@*/ /*@keep@*/ void* handler_user_data, mhd_interface_t interface );
...
#pragma pack(1)
struct host_event_header_struct
{
    uint16_t             reserved1;
    uint16_t             flags;
    mhd_event_num_t      event_type;
    mhd_event_status_t   status;
    mhd_event_reason_t   reason;
    uint32_t             auth_type;
    uint32_t             datalen;
    host_mac_t          addr;
...
#endif
#endif /* ifndef INCLUDED_MHD_EVENTS_H */
