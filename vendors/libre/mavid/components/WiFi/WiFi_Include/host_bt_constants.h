...
/** @file
 *  Defines common constants and types for the HOST Bluetooth Framework
 */
...
/** @cond !ADDTHIS*/
#define HOST_BT_ADDRESS_BYTE_SIZE 6
/** @endcond */
...
typedef struct
{
    uint8_t address[HOST_BT_ADDRESS_BYTE_SIZE]; /**< Address. 48-bit Bluetooth device address in a little-endian format */
} host_bt_device_address_t;
...
typedef struct
{
    ...
    host_bt_uuid_size_t size;                  /**< UUID size              */
